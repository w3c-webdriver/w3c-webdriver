...
With this package the Nightwatch.js runner is disabled in favour of any type of test runner or other custom usage. Check the [cucumber-example](https://github.com/mucsi96/w3c-webdriver/tree/master/packages/cucumber-example) to see how can it be used with Cucumber.js
...
```terminal
npm install --save-dev w3c-webdriver
```
...
For complete working examples check out the [node-example](https://github.com/mucsi96/w3c-webdriver/tree/master/packages/node-example), [jest-example](https://github.com/mucsi96/w3c-webdriver/tree/master/packages/jest-example) and [cucumber-example](https://github.com/mucsi96/w3c-webdriver/tree/master/packages/cucumber-example) folders of the source code.
