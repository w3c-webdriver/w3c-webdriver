   ...
   */
{
     ...
     /**
          ...
          */
     getText: () => (0, _rest.GET)(`${url}/session/${sessionId}/element/${elementId}/text`).then(body => body.value),
     ...
     /**
          ...
          */
     getCss: propertyName => (0, _rest.GET)(`${url}/session/${sessionId}/element/${elementId}/css/${propertyName}`).then(body => body.value)
});